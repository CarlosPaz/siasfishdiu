...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Modificar Unidad de Medida</h4>
        </div>
                        ...
                        <div class="form-group row-fluid " style="display: table">
                            ...
                            <div class="controls col-lg-8">
                                <span class="row-fluid k-textbox">
                                    <input id="txt_nombre_completo" name="txt_descripcion" class="form-control " value="<?php if (isset($txt_descripcion)) echo $txt_descripcion ?>">
                                </span>
                            </div>
                        </div>                      
                        <div class="form-group row-fluid " style="display: table">

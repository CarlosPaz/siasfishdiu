                ...
                <div class="col-lg-12">
                    <form id="frmNew" action="<?= site_url('#') ?>" method="POST" role="form">
                        ...
                        <div class="form-group row-fluid " style="display: table">
                            <label for="normal-field" class="control-label col-lg-4">Nombre</label>
...
<!--                        <div class="form-group row-fluid " style="display: table">
                        ...
                        <div class="form-group row-fluid " style="display: table">
                            <label for="normal-field" class="control-label col-lg-4">Nro. de Identificación</label>
                            <div class="controls col-lg-8">
                                <span class="row-fluid k-textbox">
                                    <input id="txt_documento_identidad" name="txt_numero_identificacion" class="form-control " value="<?php if (isset($txt_numero_identificacion)) echo $txt_numero_identificacion ?>">
                                </span>
                            </div>
                        </div>
                        <div class="form-group row-fluid " style="display: table">
                        ...
                        <div class="form-group row-fluid " style="display: table">
                            ...
                            <div class="controls col-lg-8">
                                <span class="row-fluid k-textbox">
                                    <input id="txt_telefono" name="txt_estado" class="form-control " value="<?php if (isset($txt_estado)) echo $txt_estado ?>">
                                </span>
                            </div>
                        </div>

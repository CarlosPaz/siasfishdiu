                        ...
                        <div class="form-group row-fluid " style="display: table">
                            ...
                            <div class="controls col-lg-8">
                                <span class="row-fluid k-textbox">
                                    <input id="txt_nombre_completo" name="txt_nombre" class="form-control " placeholder="Ingrese Nombre">
                                </span>
                            </div>
                        </div>
<!--                        <div class="form-group row-fluid " style="display: table">
                        ...
                        <div class="form-group row-fluid " style="display: table">
                            ...
                            <div class="controls col-lg-8">
                                <span class="row-fluid k-textbox">
                                    <input id="txt_documento_identidad" name="txt_identificacion" class="form-control " placeholder="Ingrese Nro. Documento">
                                </span>
                            </div>
                        </div>
                        <div class="form-group row-fluid " style="display: table">
